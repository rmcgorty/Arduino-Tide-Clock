...
const prog_float_t Amp[] PROGMEM = {0.066,1.138,0.22,0.049,0.043,1.824,0.01,0,0.013,0,0.427,0.052,0.722,0.036,0.358,0.135,0.013,0.007,0.013,0.751,0,0,0.046,0.01,0.052,0.082,0.03,0,0,0,0,0,0,0,0,0.226,0};
