/*  TidelibLaJollaScrippsInstitutionWharfCalifornia.cpp 
...
// Selected station: La Jolla (Scripps Institution Wharf), California
char stationID[] = "La Jolla (Scripps Institution Wharf), California";
// Selection station ID number: 9410230
const long stationIDnumber = 9410230;
...
const float Datum = 2.73 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.066,1.089,0.19,0.033,0.036,1.64,0.01,0,0,0,0.384,0.049,0.699,0.033,0.344,0.125,0.016,0.01,0,0.669,0,0,0.036,0.01,0.056,0.075,0.023,0,0,0,0,0,0,0,0,0.259,0.052};
